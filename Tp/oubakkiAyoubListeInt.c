...
#include <time.h>
#include <errno.h>
#include "oubakkiAyoubListeInt.h"
    ...
    if (prem != NULL)
    {
        ...
        if (f == NULL)
            ...
            while (prem != NULL)
            {
                ...
                // si il y a une erreur d'ecriture (si la fwrite return un nombre different à 1)
...
// void supprime_elt(maillon_int * premier,int val){
